      ...
      <View className="mt-6 space-y-6">
        <View className="flex-row items-center gap-2">
          <Switch
            ...
            trackColor={{ false: '#353535', true: '#372560' }}
        ...
        <TextInput
          ...
          placeholder="Sinta-se livre para adicionar fotos, vídeos e relatos sobre essas experiências que você quer lembrar para sempre."
        />
